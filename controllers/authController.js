...
const register = async (req, res,next) => {
  try {
    const { name, email, phone, userType,adminKey, password, cpassword } = req.body;
    ...
    if (password !== cpassword) {
      ...
      if (userExist) {
        ...
        let user
        if (userType === "admin") {
           user = new User({ name, email, phone, userType,adminKey, password, cpassword });

        }else{
        
           user = new User({ name, email, phone, userType, adminKey:"null", password, cpassword });
        }
      ...
      <tr>
        <td style="padding: 50px; background-color: #fff; max-width: 660px">
          <table width="100%" style="">
            <tr>
              <td style="text-align:center">
                <h1 style="font-size: 30px; color: #202225; margin-top: 0;">Hello Thanks for using our website</h1>
                <p style="font-size: 18px; margin-bottom: 30px; color: #202225; max-width: 60ch; margin-left: auto; margin-right: auto">click the button below to verify.</p>
                ...
                <div style="text-align: justify; margin:20px; display: flex;">
                  ...
                  <div style="flex: 1; margin-right: 20px;">
                    ...
                    <h1 style="font-size: 20px; color: #202225; margin-top: 0;">Role :</h1>
                  </div>
                  <div style="flex: 1;">
                ...
                <a href="${resetLink}" style="background-color: #4f46e5; color: #fff; padding: 8px 24px; border-radius: 8px; border-style: solid; border-color: #4f46e5; font-size: 14px; text-decoration: none; cursor: pointer">Verify</a>
              </td>
            </tr>
          </table>
        </td>
    ...
    if (userFind) {
        ...
        if (setUserToken) {
          const mailOptions = {
            from:process.env.SENDER_EMAIL,
            to:email,
            subject:"marti-kulmis User Verification",
